...
const events = [
  ...
  {
    date: '28 сентября',
    title: 'Знакомство с детским домом',
    text: 'Первая встреча волонтёров с воспитанниками и педагогами: экскурсия, знакомство, планирование совместных мероприятий.'
  },
  {
    date: '10 октября',
  ...
  {
    date: '24 октября',
    title: 'Квест-игра для детей',
    text: 'Командная игра с заданиями на территории детского дома: логика, творчество и совместные испытания.'
  },
  {
    date: '14 ноября',
  ...
  },
  {
    ...
    text: 'Продажа изделий, сделанных на мастер-классах, в пользу подшефных семей. Все вырученные средства идут на подарки к Новому году.'
  },
  {
    date: '5 декабря',
  ...
  {
    date: '20 декабря',
    title: 'Подведение итогов семестра',
    text: 'Встреча волонтёров: разбираем, что удалось, благодарим участников и намечаем план мероприятий на следующий семестр.'
  }
];
